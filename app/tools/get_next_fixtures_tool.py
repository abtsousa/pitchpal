"""
Next fixtures tool for retrieving upcoming matches.
"""
...
class GetNextFixturesTool:
    """Tool for retrieving upcoming football fixtures."""
    ...
    def get_next_fixtures(
        ...
        writer(f"Fetching next {next_count} fixtures")
        if league_name:
